        ...
        match expression {
            Expression::ArithmeticExpression {
                ...
                match (left, operator, right) {
                    (Expression::Integer(l), Operator::Add, Expression::Integer(r)) => Expression::Integer(l + r),
                    (Expression::Integer(l), Operator::Subtract, Expression::Integer(r)) => Expression::Integer(l - r),
                    (Expression::Integer(l), Operator::Multiply, Expression::Integer(r)) => Expression::Integer(l * r),
                    (Expression::Integer(l), Operator::Divide, Expression::Integer(r)) if r != 0 => Expression::Integer(l / r),
